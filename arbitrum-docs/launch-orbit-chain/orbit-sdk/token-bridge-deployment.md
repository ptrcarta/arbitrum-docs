...
Following the [deployment](token-bridge-deployment.md) and initialization of the Orbit chain, the subsequent phase involves deploying contracts on both the parent and child chains. 
